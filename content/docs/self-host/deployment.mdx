---
title: Deployment
description: Deploy the vantezzen/pay Next.js app.
---

vantezzen/pay is a standard Next.js app. Vercel is the simplest target, but any host
